...
> [!IMPORTANT]
> 이 저장소는 공개 열람이 가능한 설계 프로젝트이지만 오픈소스 또는 오픈 하드웨어로 사용 허가된 저장소가 아닙니다. 별도 서면 허가 없이 설계·코드·문서·이미지를 제품 생산, 판매, 유료 설치, OEM/ODM, 재배포 또는 상업적 파생 제품에 사용할 수 없습니다. 자세한 내용은 [권리 및 상업적 이용 정책](RIGHTS.md)을 확인하십시오.
...
- 앱·펌웨어·카메라 기반 생육 분석 연동
- 소규모 재배 실증과 맞춤형 시제품 개발
- 키트 제작, 제조 이관, OEM/ODM 검토
- 설계와 소프트웨어의 상업적 라이선스

상업적 이용 또는 협업 문의는 [새 이슈](https://github.com/nightandweather/sproutcam-kit/issues/new)를 통해 먼저 연락해 주십시오. 이슈는 공개되므로 예산, 계약서, 기술 비밀과 개인정보는 작성하지 마십시오.

## 프로젝트 후원

이 프로젝트의 공개 문서, 실험 기록과 후속 시제품 개발을 후원하려면 [GitHub Sponsors](https://github.com/sponsors/nightandweather)를 이용할 수 있습니다. 후원은 상업적 사용권을 부여하지 않습니다.

## 권리

Copyright © 2026 Lee Kang Houn. All rights reserved.

이 저장소에 별도 라이선스가 명시되지 않은 한 모든 권리는 저작권자에게 유보됩니다. 공개 저장소라는 사실이나 GitHub에서 포크할 수 있다는 사실만으로 제조·판매·재배포 또는 파생 저작물 작성 권한이 부여되지는 않습니다. 전체 정책은 [RIGHTS.md](RIGHTS.md)를 참조하십시오.
